	...
	<div class="container-fluid py-5">
		<div class="row px-xl-5">
				...
				<div id="product-carousel" class="carousel slide"
					...
					<div class="carousel-inner border">
						<div class="carousel-item active">
							<img class="img-fluid "
								src="<c:url value="/assets/user/img/product/${pdetails.image}"/>"
								alt="Image">
			...
			<div class="col-lg-7 pb-5">
				<h3 class="font-weight-semi-bold">${pdetails.productName}</h3>
				...
				<h3 class="font-weight-semi-bold mb-4">${pdetails.price}</h3>
				<p class="mb-4">${pdetails.productContent}</p>
				...
				<div class="d-flex align-items-center mb-4 pt-2">
					...
					<a href="<c:url value="/AddCart/${pdetails.id}"/>"><button
							type="submit" class="btn btn-primary px-3">
