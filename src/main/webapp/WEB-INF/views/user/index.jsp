				...
				<div id="header-carousel" class="carousel slide"
					...
					<div class="carousel-inner">
						<div class="carousel-item active" style="height: 410px;">
							<img class="img-fluid"
								src="<c:url value="/assets/user/img/carousel-1.jpg"/>"
								alt="Image">
							<div
						...
						<div class="carousel-item" style="height: 410px;">
							<img class="img-fluid"
								src="<c:url value="/assets/user/img/carousel-2.jpg"/>"
								alt="Image">
							<div
								class="carousel-caption d-flex flex-column align-items-center justify-content-center">
								<div class="p-3" style="max-width: 700px;">
		...
		<div class="row px-xl-5 pb-3">
			<div class="col-lg-4 col-md-6 pb-1">
				<div class="cat-item d-flex flex-column border mb-4"
					...
					<a href="" class="cat-img position-relative overflow-hidden mb-3">
						<img class="img-fluid"
						src="<c:url value="/assets/user/img/cat-1.jpg"/>" alt="">
					</a>
			...
			<div class="col-lg-4 col-md-6 pb-1">
				<div class="cat-item d-flex flex-column border mb-4"
					...
					<a href="" class="cat-img position-relative overflow-hidden mb-3">
						<img class="img-fluid"
						src="<c:url value="/assets/user/img/cat-2.jpg"/>" alt="">
					</a>
			...
			<div class="col-lg-4 col-md-6 pb-1">
				<div class="cat-item d-flex flex-column border mb-4"
					...
					<a href="" class="cat-img position-relative overflow-hidden mb-3">
						<img class="img-fluid"
						src="<c:url value="/assets/user/img/cat-3.jpg"/>" alt="">
					</a>
			...
			<div class="col-lg-4 col-md-6 pb-1">
				<div class="cat-item d-flex flex-column border mb-4"
					...
					<a href="" class="cat-img position-relative overflow-hidden mb-3">
						<img class="img-fluid"
						src="<c:url value="/assets/user/img/cat-4.jpg"/>" alt="">
					</a>
			...
			<div class="col-lg-4 col-md-6 pb-1">
				<div class="cat-item d-flex flex-column border mb-4"
					...
					<a href="" class="cat-img position-relative overflow-hidden mb-3">
						<img class="img-fluid"
						src="<c:url value="/assets/user/img/cat-5.jpg"/>" alt="">
					</a>
			...
			<div class="col-lg-4 col-md-6 pb-1">
				<div class="cat-item d-flex flex-column border mb-4"
					...
					<a href="" class="cat-img position-relative overflow-hidden mb-3">
						<img class="img-fluid"
						src="<c:url value="/assets/user/img/cat-6.jpg"/>" alt="">
					</a>
		...
		<div class="row px-xl-5">
			<div class="col-md-6 pb-4">
				<div
					...
					<img src="<c:url value="/assets/user/img/offer-1.png"/>" alt="">
			...
			<div class="col-md-6 pb-4">
				<div
					...
					<img src="<c:url value="/assets/user/img/offer-2.png"/>" alt="">
					<div class="position-relative" style="z-index: 1;">
						<h5 class="text-uppercase text-primary mb-3">20% off the all
							order</h5>
			...
			<c:if test="${products.size()>0 }">
				<div class="col-lg-3 col-md-6 col-sm-12 pb-1">
					<c:forEach var="p" items="${products}" varStatus="loop">
						...
						<c:if
							test="${ (loop.index + 1) % 2 == 0 || (loop.index + 1)  == products.size() }">
				</div>
	...
	<div class="container-fluid pt-5">
		...
		<div class="row px-xl-5 pb-3">
			<c:if test="${productsnew.size()>0 }">
				<div class="col-lg-3 col-md-6 col-sm-12 pb-1">
					<c:forEach var="pn" items="${productsnew}" varStatus="loop">
						<div class="card product-item border-0 mb-4">
							<div
								class="card-header product-img position-relative overflow-hidden bg-transparent border p-0">
								<img class="" width="300" height="300"
									src="<c:url value="/assets/user/img/product/${pn.image}"/>"
									alt="">
							</div>
							<div
								class="card-body border-left border-right text-center p-0 pt-4 pb-3">
								<h6 class="text-truncate mb-3">${pn.productName}</h6>
								<div class="d-flex justify-content-center">
									<h6>${pn.price}</h6>
			...
			<div class="col">
				<div class="owl-carousel vendor-carousel">
					<div class="vendor-item border p-4">
						<img src="<c:url value="/assets/user/img/vendor-1.jpg"/>" alt="">
					</div>
					<div class="vendor-item border p-4">
						<img src="<c:url value="/assets/user/img/vendor-2.jpg"/>" alt="">
					</div>
					<div class="vendor-item border p-4">
						<img src="<c:url value="/assets/user/img/vendor-3.jpg"/>" alt="">
					</div>
					<div class="vendor-item border p-4">
						<img src="<c:url value="/assets/user/img/vendor-4.jpg"/>" alt="">
					</div>
					<div class="vendor-item border p-4">
						<img src="<c:url value="/assets/user/img/vendor-5.jpg"/>" alt="">
					</div>
					<div class="vendor-item border p-4">
						<img src="<c:url value="/assets/user/img/vendor-6.jpg"/>" alt="">
					</div>
					<div class="vendor-item border p-4">
						<img src="<c:url value="/assets/user/img/vendor-7.jpg"/>" alt="">
					</div>
					<div class="vendor-item border p-4">
						<img src="<c:url value="/assets/user/img/vendor-8.jpg"/>" alt="">
